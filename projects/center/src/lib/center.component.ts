          ...
          <ul nz-menu nzMode="inline">
            <li nz-menu-group nzTitle="个人设置">
              <ul>
                ...
                <li nz-menu-item nzMatchRouter [routerLink]="['email']">
                  <i nz-icon nzType="mail"></i> <span>业务邮箱</span>
                </li>
                <li nz-menu-item nzMatchRouter [routerLink]="['password']">
            ...
            <li nz-menu-group nzTitle="消息中心">
              <ul>
                <li nz-menu-item nzMatchRouter [routerLink]="['notification']">
                  <i nz-icon nzType="notification"></i> <span>消息列表</span>
                </li>
                <li nz-menu-item nzMatchRouter [routerLink]="['prompt']">
            ...
            <li nz-menu-group nzTitle="其他设置">
              <ul>
                <li nz-menu-item nzMatchRouter [routerLink]="['third-party']">
                  <i nz-icon nzType="link"></i> <span>第三方绑定</span>
                </li>
                <li nz-menu-item nzMatchRouter [routerLink]="['audit']">
